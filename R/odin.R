...
model_ <- R6::R6Class(
  ...
  private = list(
    ...
    dll = "AMRSpreadModel",
    user = c("a", "AR0", "As0", "b", "c_A", "c_D", "c_T", "DR0", "Ds0", "e",
             "Ev_r0", "Ev_s0", "fT", "Iv_r0", "Iv_s0", "m", "mu", "n", "Phi",
             "rA", "rD", "res_start", "res_time", "rTR_true", "rTs", "S0",
             "Sv0", "toff", "ton", "TR0", "Ts0"),
    ...
    registration = function() {
      if (FALSE) {
        .C("model_rhs_dde", package = "AMRSpreadModel")
        .C("model_rhs_desolve", package = "AMRSpreadModel")
        .C("model_initmod_desolve", package = "AMRSpreadModel")
        .C("model_output_dde", package = "AMRSpreadModel")
      }
    },
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
      ...
      private$ptr <- .Call("model_create", user, PACKAGE = "AMRSpreadModel")
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      ...
      .Call("model_set_user", private$ptr, user, PACKAGE = "AMRSpreadModel")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("model_initial_conditions", private$ptr, t, PACKAGE = "AMRSpreadModel")
    },

    rhs = function(t, y) {
      .Call("model_rhs_r", private$ptr, t, y, PACKAGE = "AMRSpreadModel")
    },
    ...
    contents = function() {
      .Call("model_contents", private$ptr, PACKAGE = "AMRSpreadModel")
    },
