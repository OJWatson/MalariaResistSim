...
SEXP model_metadata(SEXP internal_p) {
  ...
  SET_STRING_ELT(output_names, 8, mkChar("invading_AR_out"));
...
void model_rhs(model_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  double invading_AR = (t < internal->res_time || t > (internal->res_time + 1) ? 0 : As * log(1 / (double) (1 - internal->init_res)));
  double invading_DR = (t < internal->res_time || t > (internal->res_time + 1) ? 0 : Ds * log(1 / (double) (1 - internal->init_res)));
  ...
  double invading_TR = (t < internal->res_time || t > (internal->res_time + 1) ? 0 : Ts * log(1 / (double) (1 - internal->init_res)));
  ...
  dstatedt[4] = invading_DR + (S * Lambda_R * internal->Phi * (1 - internal->fT) + Lambda_R * As * internal->Phi * (1 - internal->fT) + Lambda_R * AR * internal->Phi * (1 - internal->fT) - DR * internal->rD);
  dstatedt[1] = (S * Lambda_s * internal->Phi * (1 - internal->fT) + Lambda_s * AR * internal->Phi * (1 - internal->fT) + Lambda_s * As * internal->Phi * (1 - internal->fT) - Ds * internal->rD) - invading_DR;
  ...
  dstatedt[6] = invading_TR + (S * Lambda_R * internal->Phi * internal->fT + Lambda_R * AR * internal->Phi * internal->fT + Lambda_R * As * internal->Phi * internal->fT - TR * rTR);
  dstatedt[3] = (S * Lambda_s * internal->Phi * internal->fT + Lambda_s * AR * internal->Phi * internal->fT + Lambda_s * As * internal->Phi * internal->fT - Ts * internal->rTs) - invading_TR;
  if (output) {
